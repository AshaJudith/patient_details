...
import 'package:patient_details/quad_clipper.dart';
        ...
        child: Row(
          ...
          children: <Widget>[
            _card(context,
                ...
                backWidget:
                _decorationContainerA(Colors.orange, 50, -30),
        ...
        child: Container(
          child: Column(
            children: <Widget>[
              ...
              SizedBox(height: 20),
              _categoryRow("General Intelligence", Colors.orange, Colors.orange),
              _featuredRowB(context),
              SizedBox(height: 20),
              _categoryRow("Symptoms", Colors.orange, Colors.orange),
              _featuredRowC(context),
              SizedBox(height: 0),
              _categoryRow("Medical details", Colors.purple,
                  Colors.purple),
